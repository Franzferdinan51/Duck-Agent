...
projection into Duck Agent' display, approval bridging, transcript projection into
...
"codex_app_server"`. Duck Agent' default tool dispatch is unchanged when this
