...
row taxonomy is inferred from the atlas shape so Duck Agent can render both legacy
...
class PetState(str, Enum):
    ...
    These are Duck Agent' activity state names. They are not always identical to the
