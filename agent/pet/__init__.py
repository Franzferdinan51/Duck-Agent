...
an 8-column × 9-row atlas; older Duck Agent/petdex sheets used an 8-row atlas.
Duck Agent infers the row taxonomy from the sheet and maps agent activity onto
