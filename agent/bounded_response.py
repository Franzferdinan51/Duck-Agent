...
When a provider returns a non-OK status on a *streaming* request, Duck Agent reads
...
streams"), generalized to cover Duck Agent'ss three streaming error-body sites
