"""Coding-context awareness — base Duck Agent, every interactive surface.

When the user runs Duck Agent inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Duck Agent shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Duck Agent should operate in its coding posture right now."""
