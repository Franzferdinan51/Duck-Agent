...
def mask_secret(
    ...
    *,
    ...
    Canonical helper for display-time redaction across Duck Agent — used by
    ``duck-agent config``, ``duck-agent status``, ``duck-agent dump``, and anywhere
...
def redact_sensitive_text(
    ...
    *,
    ...
    for URLs, ``"eyJ" in text`` for JWTs). On a typical duck-agent log line
