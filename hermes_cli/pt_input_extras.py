...
key tuples Duck Agent already binds.
...
def install_shift_enter_alias() -> int:
    ...
    at the application layer — the sequences above never reach Duck Agent.
...
def install_cmd_backspace_alias() -> int:
    ...
    try:
        ...
        return 0
    aliases = {'\x1b[127;9u': Keys.ControlU, '\x1b[127;10u': Keys.ControlU, '\x1b[27;9;127~': Keys.ControlU, '\x1b[3;9~': Keys.ControlK, '\x1b[3;10~': Keys.ControlK}
    changed = 0
