...
through ``duck-agent config set``, ``.env``, and ``config.yaml``; the gateway reads
...
"""
SETUP_HIDDEN_ENV_SUFFIXES = ('_HOME_CHANNEL', '_HOME_CHANNEL_NAME', '_HOME_CHANNEL_THREAD_ID', '_HOME_ADDRESS', '_ALLOW_ALL_USERS', '_REPLY_TO_MODE', '_REPLY_MODE', '_REQUIRE_MENTION', '_AUTO_THREAD', '_FREE_RESPONSE_CHANNELS', '_FREE_RESPONSE_ROOMS', '_ALLOWED_CHANNELS', '_PROXY')
