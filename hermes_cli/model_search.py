...
_MODEL_SEARCH_ALIASES: dict[str, tuple[str, ...]] = {'k3': ('kimi-k3', 'kimi')}
_MODEL_ALIAS_CANONICAL: dict[str, str] = {wire_id: aliases[0].lower() for wire_id, aliases in _MODEL_SEARCH_ALIASES.items() if aliases}
