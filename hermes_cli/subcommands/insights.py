"""``duck-agent insights`` subcommand parser.
...
def build_insights_parser(subparsers, *, cmd_insights: Callable) -> None:
    ...
    insights_parser = subparsers.add_parser('insights', help='Show usage insights and analytics', description='Analyze session history to show token usage, costs, tool patterns, and activity trends')
