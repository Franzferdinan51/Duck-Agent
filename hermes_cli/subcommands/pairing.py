"""``duck-agent pairing`` subcommand parser.
...
def build_pairing_parser(subparsers, *, cmd_pairing: Callable) -> None:
    ...
    pairing_parser = subparsers.add_parser('pairing', help='Manage DM pairing codes for user authorization', description='Approve or revoke user access via pairing codes')
    ...
    pairing_approve_parser.add_argument('code', metavar='request-id|code', help="Request ID from 'pairing list', or the code the bot DM'd the user")
