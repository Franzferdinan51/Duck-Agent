...
Design constraints (see duck-agent-dev skill — message-flow + cache
invariants):
...
StreamEvent = Union[MessageChunk, MessageStop, Commentary, ToolCallChunk, ToolCallFinished, LongToolHint, GatewayNotice]
__all__ = ['MessageChunk', 'MessageStop', 'Commentary', 'ToolCallChunk', 'ToolCallFinished', 'LongToolHint', 'GatewayNotice', 'StreamEvent']