#!/usr/bin/env python3
"""
Skills Hub — Source adapters and hub state management for the Duck Agent Skills Hub.
...
class OptionalSkillSource(SkillSource):
    ...
    ~/.duck-agent/skills/ during setup.  They are discoverable via the Skills Hub
...
class HermesIndexSource(SkillSource):
    """Skill source backed by the centralized Duck Agent Skills Index.
