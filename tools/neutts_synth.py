...
def main():
    ...
    parser.add_argument('--model', default='neuphonic/neutts-air-q4-gguf', help='HuggingFace backbone model repo')
    ...
    try:
        ...
        sys.exit(1)
    tts = NeuTTS(backbone_repo=args.model, backbone_device=backbone_device, codec_repo='neuphonic/neucodec', codec_device=codec_device)
