"""Shared Duck Agent-side execution flow for Modal transports.

This module deliberately stops at the Duck Agent boundary:
- command preparation
...
class BaseModalExecutionEnvironment(BaseEnvironment):
    ...
    def _prepare_modal_exec(self, command: str, *, cwd: str='', timeout: int | None=None, stdin_data: str | None=None) -> PreparedModalExec:
        ...
        return PreparedModalExec(command=exec_command, cwd=effective_cwd, timeout=effective_timeout, stdin_data=exec_stdin)
