...
def _launch_cwd_for_session(source: str) -> Optional[str]:
    ...
    launched from is meaningful for ``duck-agent -c`` / ``--resume`` (relaunch
...
from agent.prompt_builder import DEFAULT_AGENT_IDENTITY, build_skills_system_prompt, build_context_files_prompt, build_environment_hints, build_nous_subscription_prompt, load_soul_md
from agent.process_bootstrap import _get_proxy_from_env
from agent.message_sanitization import _SURROGATE_RE, _sanitize_surrogates, _sanitize_structure_surrogates, _sanitize_messages_surrogates, _escape_invalid_chars_in_json_strings, _repair_tool_call_arguments, _strip_non_ascii, _sanitize_messages_non_ascii, _sanitize_tools_non_ascii, _strip_images_from_messages, _sanitize_structure_non_ascii, coalesce_tool_call_id as _sanitize_coalesce_tool_call_id, uniquify_tool_call_ids as _sanitize_uniquify_tool_call_ids
from agent.codex_responses_adapter import _derive_responses_function_call_id as _codex_derive_responses_function_call_id, _deterministic_call_id as _codex_deterministic_call_id, _split_responses_tool_id as _codex_split_responses_tool_id, _summarize_user_message_for_log
from agent.tool_guardrails import ToolGuardrailDecision, append_toolguard_guidance, toolguard_synthetic_result
from agent.tool_result_classification import FILE_MUTATING_TOOL_NAMES as _FILE_MUTATING_TOOLS, file_mutation_result_landed
from agent.trajectory import convert_scratchpad_to_think, save_trajectory as _save_trajectory_to_file
from agent.tool_dispatch_helpers import _should_parallelize_tool_batch, _is_destructive_command, _extract_parallel_scope_path, _paths_overlap, _is_multimodal_tool_result, _multimodal_text_summary, _append_subdir_hint_to_multimodal, _extract_file_mutation_targets, _extract_landed_file_mutation_paths, _extract_error_preview, _trajectory_normalize_msg
from utils import atomic_json_write, base_url_host_matches, base_url_hostname, env_float, is_truthy_value, model_forces_max_completion_tokens
_EPHEMERAL_SCAFFOLDING_FLAGS = ('_empty_recovery_synthetic', '_empty_terminal_sentinel', '_thinking_prefill', '_verification_stop_synthetic', '_pre_verify_synthetic', '_kanban_stop_synthetic', '_dropped_toolcall_nudge')
...
def _qwen_portal_headers() -> dict:
    ...
    return {'User-Agent': _ua, 'X-DashScope-CacheControl': 'enable', 'X-DashScope-UserAgent': _ua, 'X-DashScope-AuthType': 'qwen-oauth'}
...
def _safe_session_filename_component(session_id: str) -> str:
    ...
    ``X-Duck Agent-Session-Id`` API header) and are otherwise interpolated raw
    into on-disk artifact filenames under ``~/.duck-agent/sessions/``.  Without
    ...
    sanitized = re.sub('[^\\w-]', '_', raw).strip('._')
...
class _StreamErrorEvent(Exception):
    ...
    def __init__(self, message: str, *, code: Optional[str]=None, param: Optional[str]=None, status_code: Optional[int]=None) -> None:
...
class AIAgent:
    ...
    """
    _TOOL_CALL_ARGUMENTS_CORRUPTION_MARKER = '[duck-agent: tool call arguments were corrupted in this session and have been dropped to keep the conversation alive. See issue #15236.]'
    ...
    def __init__(self, base_url: str=None, api_key: str=None, provider: str=None, api_mode: str=None, acp_command: str=None, acp_args: list[str] | None=None, command: str=None, args: list[str] | None=None, model: str='', max_iterations: int=90, tool_delay: float=None, enabled_toolsets: List[str]=None, disabled_toolsets: List[str]=None, save_trajectories: bool=False, verbose_logging: bool=False, quiet_mode: bool=False, tool_progress_mode: str='all', ephemeral_system_prompt: str=None, log_prefix_chars: int=100, log_prefix: str='', providers_allowed: List[str]=None, providers_ignored: List[str]=None, providers_order: List[str]=None, provider_sort: str=None, provider_require_parameters: bool=False, provider_data_collection: str=None, openrouter_min_coding_score: Optional[float]=None, session_id: str=None, tool_progress_callback: callable=None, tool_start_callback: callable=None, tool_complete_callback: callable=None, thinking_callback: callable=None, reasoning_callback: callable=None, clarify_callback: callable=None, read_terminal_callback: callable=None, read_preview_callback: callable=None, step_callback: callable=None, stream_delta_callback: callable=None, interim_assistant_callback: callable=None, tool_gen_callback: callable=None, status_callback: callable=None, notice_callback: callable=None, notice_clear_callback: callable=None, event_callback: Optional[Callable[[str, dict], None]]=None, reaction_callback: Optional[Callable[[str], None]]=None, max_tokens: int=None, reasoning_config: Dict[str, Any]=None, service_tier: str=None, request_overrides: Dict[str, Any]=None, prefill_messages: List[Dict[str, Any]]=None, platform: str=None, user_id: str=None, user_id_alt: str=None, user_name: str=None, chat_id: str=None, chat_name: str=None, chat_type: str=None, thread_id: str=None, gateway_session_key: str=None, skip_context_files: bool=False, load_soul_identity: bool=False, skip_memory: bool=False, skip_background_review: bool=False, session_db=None, parent_session_id: str=None, iteration_budget: 'IterationBudget'=None, fallback_model: Dict[str, Any]=None, credential_pool=None, checkpoints_enabled: bool=False, checkpoint_max_snapshots: int=20, checkpoint_max_total_size_mb: int=500, checkpoint_max_file_size_mb: int=10, pass_session_id: bool=False, requested_provider: str=None):
        """Forwarder — see ``agent.agent_init.init_agent``."""
        if tool_delay is not None:
            warnings.warn('tool_delay is deprecated and ignored; sequential tool calls no longer sleep between executions.', DeprecationWarning, stacklevel=2)
        from agent.agent_init import init_agent
        init_agent(self, base_url=base_url, api_key=api_key, provider=provider, requested_provider=requested_provider, api_mode=api_mode, acp_command=acp_command, acp_args=acp_args, command=command, args=args, model=model, max_iterations=max_iterations, enabled_toolsets=enabled_toolsets, disabled_toolsets=disabled_toolsets, save_trajectories=save_trajectories, verbose_logging=verbose_logging, quiet_mode=quiet_mode, tool_progress_mode=tool_progress_mode, ephemeral_system_prompt=ephemeral_system_prompt, log_prefix_chars=log_prefix_chars, log_prefix=log_prefix, providers_allowed=providers_allowed, providers_ignored=providers_ignored, providers_order=providers_order, provider_sort=provider_sort, provider_require_parameters=provider_require_parameters, provider_data_collection=provider_data_collection, openrouter_min_coding_score=openrouter_min_coding_score, session_id=session_id, tool_progress_callback=tool_progress_callback, tool_start_callback=tool_start_callback, tool_complete_callback=tool_complete_callback, thinking_callback=thinking_callback, reasoning_callback=reasoning_callback, clarify_callback=clarify_callback, read_terminal_callback=read_terminal_callback, read_preview_callback=read_preview_callback, step_callback=step_callback, stream_delta_callback=stream_delta_callback, interim_assistant_callback=interim_assistant_callback, tool_gen_callback=tool_gen_callback, status_callback=status_callback, notice_callback=notice_callback, notice_clear_callback=notice_clear_callback, event_callback=event_callback, reaction_callback=reaction_callback, max_tokens=max_tokens, reasoning_config=reasoning_config, service_tier=service_tier, request_overrides=request_overrides, prefill_messages=prefill_messages, platform=platform, user_id=user_id, user_id_alt=user_id_alt, user_name=user_name, chat_id=chat_id, chat_name=chat_name, chat_type=chat_type, thread_id=thread_id, gateway_session_key=gateway_session_key, skip_context_files=skip_context_files, load_soul_identity=load_soul_identity, skip_memory=skip_memory, skip_background_review=skip_background_review, session_db=session_db, parent_session_id=parent_session_id, iteration_budget=iteration_budget, fallback_model=fallback_model, credential_pool=credential_pool, checkpoints_enabled=checkpoints_enabled, checkpoint_max_snapshots=checkpoint_max_snapshots, checkpoint_max_total_size_mb=checkpoint_max_total_size_mb, checkpoint_max_file_size_mb=checkpoint_max_file_size_mb, pass_session_id=pass_session_id)
    ...
    def _ensure_db_session(self) -> None:
        ...
        try:
            ...
            try:
                ...
                pass
            self._session_db.create_session(session_id=self.session_id, source=source, model=self.model, model_config=_init_model_config, system_prompt=self._cached_system_prompt, user_id=None, parent_session_id=self._parent_session_id, cwd=_launch_cwd_for_session(source), profile_name=_profile_for_session)
            self._session_db_created = True
        except Exception as e:
            logger.warning('Session DB creation failed (will retry next turn): %s', e)

    def _transition_context_engine_session(self, *, old_session_id: Optional[str]=None, new_session_id: Optional[str]=None, previous_messages: Optional[list]=None, carry_over_context: bool=False, reset_engine: bool=True, **extra_context) -> None:
        ...
        if should_start and target_session_id and hasattr(engine, 'on_session_start'):
            start_context = {'old_session_id': old_session_id, 'carry_over_context': carry_over_context, 'platform': _session_source_for_agent(getattr(self, 'platform', None)), 'model': getattr(self, 'model', ''), 'context_length': getattr(engine, 'context_length', None), 'conversation_id': getattr(self, '_gateway_session_key', None)}
        ...
        if carry_over_context and old_session_id and target_session_id and hasattr(engine, 'carry_over_new_session_context'):
            try:
    ...
    def reset_session_state(self, previous_messages: Optional[list]=None, old_session_id: Optional[str]=None, carry_over_context: bool=False):
        ...
        self._transition_context_engine_session(old_session_id=old_session_id, new_session_id=getattr(self, 'session_id', None), previous_messages=previous_messages, carry_over_context=carry_over_context, reset_engine=True)
        engine = getattr(self, 'context_compressor', None)
        target_session_id = getattr(self, 'session_id', '') or ''
        bound_session_id = getattr(engine, '_session_id', '') if engine is not None else ''
        if engine is not None and hasattr(engine, 'bind_session_state') and target_session_id and (target_session_id != bound_session_id):
            try:
    ...
    def _effective_lmstudio_context_length(config_context_length: Optional[int], runtime_context_length: Any) -> Optional[int]:
        ...
        explicit = config_context_length if isinstance(config_context_length, int) and (not isinstance(config_context_length, bool)) and (config_context_length > 0) else None
        runtime_value = getattr(runtime_context_length, 'context_length', runtime_context_length)
        runtime = runtime_value if isinstance(runtime_value, int) and (not isinstance(runtime_value, bool)) and (runtime_value > 0) else None
        if bool(getattr(runtime_context_length, 'rejected', False)) or (bool(getattr(runtime_context_length, 'load_attempted', False)) and runtime is None):
            return None
    ...
    def _lmstudio_load_was_unverified(load_result: Any) -> bool:
        ...
        return bool(getattr(load_result, 'rejected', False)) or (bool(getattr(load_result, 'load_attempted', False)) and getattr(load_result, 'context_length', None) is None)
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int]=None) -> Any:
        ...
        return ensure_lmstudio_model_loaded(self.model, self.base_url, getattr(self, 'api_key', ''), config_context_length, return_load_result=True)
    ...
    def _vprint(self, *args, force: bool=False, **kwargs):
        ...
        parseable single-query flows such as ``duck-agent chat -q``. In that mode,
    ...
    def _warn_context_overflow_blocked(self, reason: str, preflight_tokens: int, threshold_tokens: int) -> None:
        ...
        if getattr(self, '_last_ctx_overflow_warn', None) != _warn_key:
            ...
            self._emit_warning(CONTEXT_OVERFLOW_BLOCKED_WARNING_TEMPLATE.format(tokens=preflight_tokens, threshold=threshold_tokens, reason=reason))
    ...
    def _stream_diag_capture_response(self, diag: Dict[str, Any], http_response: Any) -> None:
    ...
    def _log_stream_retry(self, *, kind: str, error: BaseException, attempt: int, max_attempts: int, mid_tool_call: bool, diag: Optional[Dict[str, Any]]=None) -> None:
        """Forwarder — see ``agent.stream_diag.log_stream_retry``."""
        from agent.stream_diag import log_stream_retry
        log_stream_retry(self, kind=kind, error=error, attempt=attempt, max_attempts=max_attempts, mid_tool_call=mid_tool_call, diag=diag)

    def _emit_stream_drop(self, *, error: BaseException, attempt: int, max_attempts: int, mid_tool_call: bool, diag: Optional[Dict[str, Any]]=None) -> None:
        """Forwarder — see ``agent.stream_diag.emit_stream_drop``."""
        from agent.stream_diag import emit_stream_drop
        emit_stream_drop(self, error=error, attempt=attempt, max_attempts=max_attempts, mid_tool_call=mid_tool_call, diag=diag)
    ...
    def _current_main_runtime(self) -> Dict[str, str]:
        ...
        return {'model': getattr(self, 'model', '') or '', 'provider': getattr(self, 'provider', '') or '', 'base_url': getattr(self, 'base_url', '') or '', 'api_key': getattr(self, 'api_key', '') or '', 'api_mode': getattr(self, 'api_mode', '') or '', 'auth_mode': getattr(self, 'auth_mode', '') or ''}
    ...
    def _is_direct_openai_url(self, base_url: str=None) -> bool:
        ...
        if base_url is not None:
            ...
            hostname = getattr(self, '_base_url_hostname', '') or base_url_hostname(getattr(self, '_base_url_lower', ''))
    ...
    def _codex_silent_hang_hint(self, model: Optional[str]=None) -> Optional[str]:
        ...
        duck-agent #21444 for the symptom history.  The upstream backend
        ...
        if self.api_mode != 'codex_responses':
            return None
        is_codex_backend = self.provider == 'openai-codex' or (getattr(self, '_base_url_hostname', '') == 'chatgpt.com' and '/backend-api/codex' in (getattr(self, '_base_url_lower', '') or ''))
        if not is_codex_backend:
            return None
        eff_model = (model if model is not None else self.model) or ''
        model_lower = eff_model.lower()
        if not re.search('(?:^|[/\\-_])gpt-5\\.5(?:$|[\\-_])', model_lower):
            return None
        return f'Codex backend appears to be silently rejecting {eff_model!r} on chatgpt.com/backend-api/codex (no stream events, no error). This is a known backend-side pattern that has affected ChatGPT Plus accounts intermittently. Workaround: try `gpt-5.4` on the same OAuth profile, or `gpt-5.3-codex`, or switch to a different model/provider in your fallback chain. Some ChatGPT Codex accounts do not support `gpt-5.4-codex`. See duck-agent#21444 for symptom history.'
    ...
    def _is_copilot_url(self) -> bool:
        ...
        return 'api.githubcopilot.com' in self._base_url_lower or 'models.github.ai' in self._base_url_lower
    ...
    def _is_codex_backend(self) -> bool:
        ...
        return getattr(self, 'api_mode', None) == 'codex_responses' and getattr(self, '_base_url_hostname', '') == 'chatgpt.com' and ('/backend-api/codex' in (getattr(self, '_base_url_lower', '') or ''))

    def _anthropic_prompt_cache_policy(self, *, provider: Optional[str]=None, base_url: Optional[str]=None, api_mode: Optional[str]=None, model: Optional[str]=None) -> tuple[bool, bool]:
    ...
    def _direct_native_anthropic_tool_cache_capability(self, *, provider: Optional[str]=None, base_url: Optional[str]=None, api_mode: Optional[str]=None, model: Optional[str]=None) -> bool:
        ...
        return _direct_native_anthropic_tool_cache_capability(self, provider=provider, base_url=base_url, api_mode=api_mode, model=model)
    ...
    def _max_tokens_param(self, value: int) -> dict:
        ...
        """
        if self._is_direct_openai_url() or self._is_azure_openai_url() or self._is_github_copilot_url() or model_forces_max_completion_tokens(self.model):
    ...
    def _should_treat_stop_as_truncated(self, finish_reason: str, assistant_message, messages: Optional[list]=None) -> bool:
        ...
        if not visible_text:
            return False
        if len(visible_text) < 20 or not re.search('\\s', visible_text):
            return False
        return not self._has_natural_response_ending(visible_text)

    def _looks_like_codex_intermediate_ack(self, user_message: str, assistant_content: str, messages: List[Dict[str, Any]], require_workspace: bool=True) -> bool:
        ...
        return looks_like_codex_intermediate_ack(self, user_message, assistant_content, messages, require_workspace)
    ...
    @staticmethod
    def _summarize_background_review_actions(review_messages: List[Dict], prior_snapshot: List[Dict], notification_mode: str='on') -> List[str]:
        """Forwarder — see ``agent.background_review.summarize_background_review_actions``."""
        from agent.background_review import summarize_background_review_actions
        return summarize_background_review_actions(review_messages, prior_snapshot, notification_mode=notification_mode)

    def _spawn_background_review(self, messages_snapshot: List[Dict], review_memory: bool=False, review_skills: bool=False, focus: Optional[str]=None) -> None:
        ...
        target, _prompt = spawn_background_review_thread(self, messages_snapshot, review_memory=review_memory, review_skills=review_skills, focus=focus)
        t = threading.Thread(target=propagate_context_to_thread(target), daemon=True, name='bg-review')
        t.start()

    def _build_memory_write_metadata(self, *, write_origin: Optional[str]=None, execution_context: Optional[str]=None, task_id: Optional[str]=None, tool_call_id: Optional[str]=None) -> Dict[str, Any]:
        ...
        return build_memory_write_metadata(self, write_origin=write_origin, execution_context=execution_context, task_id=task_id, tool_call_id=tool_call_id)
    ...
    def _apply_persist_user_message_override(self, messages: List[Dict]) -> None:
        ...
        if 0 <= idx < len(messages):
            ...
            if isinstance(msg, dict) and msg.get('role') == 'user':
                if override is not None and (not msg.get(COMPRESSED_SUMMARY_METADATA_KEY)) and (not isinstance(msg.get('content'), list) or isinstance(override, list)):
    ...
    def _drop_trailing_empty_response_scaffolding(self, messages: List[Dict]) -> None:
        ...
        while messages and isinstance(messages[-1], dict) and (messages[-1].get('_empty_recovery_synthetic') or messages[-1].get('_empty_terminal_sentinel')):
            messages.pop()
    ...
    def _flush_messages_to_session_db_unlocked(self, messages: List[Dict], conversation_history: Optional[List[Dict]]=None):
        ...
        try:
            ...
            if isinstance(_prev_prefix, list):
                ...
                while _scan_start < _limit and messages[_scan_start] is _prev_prefix[_scan_start]:
                    _scan_start += 1
            ...
            for _msg_idx in range(_scan_start, len(messages)):
                ...
                if is_current_turn_user and msg.get('role') == 'user':
                    if _ov_content is not None and (not isinstance(content, list) or isinstance(_ov_content, list)) and (not msg.get(COMPRESSED_SUMMARY_METADATA_KEY)):
                        if _row_api_content is None and isinstance(content, str) and (content != _ov_content):
                ...
                if _row_api_content == content:
                    _row_api_content = None
                if _row_api_content is None and role in ('user', 'assistant') and isinstance(content, str) and content and (sanitize_context(content).strip() != content.strip()):
                    _row_api_content = content
                ...
                _batch_rows.append({'role': role, 'content': content, 'tool_name': msg.get('tool_name'), 'tool_calls': tool_calls_data, 'tool_call_id': msg.get('tool_call_id'), 'finish_reason': msg.get('finish_reason'), 'reasoning': msg.get('reasoning'), 'reasoning_content': msg.get('reasoning_content'), 'reasoning_details': msg.get('reasoning_details'), 'codex_reasoning_items': msg.get('codex_reasoning_items'), 'codex_message_items': msg.get('codex_message_items'), 'timestamp': _row_timestamp, 'api_content': _row_api_content, 'display_kind': 'hidden' if msg.get(COMPRESSED_SUMMARY_METADATA_KEY) and (ContextCompressor.classify_summary_content(msg.get('content')) == 'standalone' or not msg.get('_compressed_summary_has_user_turn')) else msg.get('display_kind'), 'display_metadata': msg.get('display_metadata')})
                _batch_msgs.append(msg)
            if _batch_rows:
                self._session_db.append_messages_batch(session_id=self.session_id, messages=_batch_rows, compression_lock_holder=getattr(self, '_active_compression_lock_holder', None))
    ...
    @staticmethod
    def _is_entitlement_failure(error_context: Optional[Dict[str, Any]], status_code: Optional[int]) -> bool:
    ...
    def _decorate_xai_entitlement_error(detail: str) -> str:
        ...
        SuperGrok subscribers can use Duck Agent against xai-oauth.  Lots of
        ...
        if not detail:
            return detail
        lower = detail.lower()
        is_entitlement = 'do not have an active grok subscription' in lower or ('out of available resources' in lower and 'grok' in lower) or ('does not have permission' in lower and 'grok' in lower)
        if not is_entitlement:
            return detail
        hint = " — xAI rejected this OAuth account. NOTE: X Premium+ does NOT include xAI API access — only standalone SuperGrok subscribers can use this provider. Other possible causes: no Grok subscription, your tier doesn't include this model, or your quota is exhausted. Check https://grok.com/?_s=usage to see which, or run `/model` to switch providers."
    ...
    def _summarize_api_error(error: Exception) -> str:
        ...
        if '<!DOCTYPE' in raw or '<html' in raw:
            m = re.search('<title[^>]*>([^<]+)</title>', raw, re.IGNORECASE)
            title = m.group(1).strip() if m else 'HTML error page (title not found)'
            ray = re.search('Cloudflare Ray ID:\\s*<strong[^>]*>([^<]+)</strong>', raw)
    ...
    def _is_sensitive_hook_key(key: Any) -> bool:
        ...
        exact = {'api_key', 'authorization', 'proxy_authorization', 'cookie', 'set_cookie'}
        return lowered in exact or lowered.endswith('_api_key')

    @classmethod
    def _hook_jsonable(cls, value: Any, *, depth: int=0, max_depth: int=8, max_string: int=8000, max_sequence: int=200) -> Any:
        if depth > max_depth:
        ...
        if isinstance(value, (list, tuple, set)):
            seq = list(value)
            out = [cls._hook_jsonable(item, depth=depth + 1, max_depth=max_depth, max_string=max_string, max_sequence=max_sequence) for item in seq[:max_sequence]]
        ...
        try:
            if hasattr(value, 'model_dump'):
                ...
                return cls._hook_jsonable(dumped, depth=depth + 1, max_depth=max_depth, max_string=max_string, max_sequence=max_sequence)
        except Exception:
            pass
        try:
            from dataclasses import asdict, is_dataclass
            if is_dataclass(value):
                return cls._hook_jsonable(asdict(value), depth=depth + 1, max_depth=max_depth, max_string=max_string, max_sequence=max_sequence)
        except Exception:
            pass
        if isinstance(value, SimpleNamespace):
            return cls._hook_jsonable(vars(value), depth=depth + 1, max_depth=max_depth, max_string=max_string, max_sequence=max_sequence)
        if hasattr(value, '__dict__'):
            try:
                public_attrs = {k: v for k, v in vars(value).items() if not str(k).startswith('_')}
                return cls._hook_jsonable(public_attrs, depth=depth + 1, max_depth=max_depth, max_string=max_string, max_sequence=max_sequence)
            except Exception:
                pass
    ...
    def _sanitize_hook_payload(cls, value: Any) -> Any:
        ...
        if len(encoded) <= limit:
            return payload
        return {'_truncated': True, 'original_type': type(value).__name__, 'preview': encoded[:limit]}

    def _api_request_payload_for_hook(self, api_kwargs: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        body = {key: value for key, value in (api_kwargs or {}).items() if key not in {'timeout', 'http_client'}}
        return self._sanitize_hook_payload({'method': 'POST', 'body': body})

    def _api_response_payload_for_hook(self, response: Any, assistant_message: Any, *, finish_reason: Optional[str]) -> Dict[str, Any]:
        tool_calls = getattr(assistant_message, 'tool_calls', None) or []
        return self._sanitize_hook_payload({'model': getattr(response, 'model', None), 'finish_reason': finish_reason, 'assistant_message': {'role': getattr(assistant_message, 'role', 'assistant'), 'content': getattr(assistant_message, 'content', None), 'tool_calls': tool_calls}, 'usage': self._usage_summary_for_api_request_hook(response)})

    def _invoke_api_request_error_hook(self, *, task_id: str, turn_id: str, api_request_id: str, api_call_count: int, api_start_time: float, api_kwargs: Optional[Dict[str, Any]], error_type: str, error_message: str, status_code: Optional[int]=None, retry_count: Optional[int]=None, max_retries: Optional[int]=None, retryable: Optional[bool]=None, reason: Optional[str]=None) -> None:
        try:
            from hermes_cli import lifecycle as _lifecycle
            if not _lifecycle.has_hook('api_request_error'):
                return
            ended_at = time.time()
            _lifecycle.invoke_hook('api_request_error', task_id=task_id, turn_id=turn_id, api_request_id=api_request_id, session_id=self.session_id or '', platform=self.platform or '', model=self.model, provider=self.provider, base_url=self.base_url, api_mode=self.api_mode, api_call_count=api_call_count, api_duration=ended_at - api_start_time, started_at=api_start_time, ended_at=ended_at, status_code=status_code, retry_count=retry_count, max_retries=max_retries, retryable=retryable, reason=reason, error={'type': error_type, 'message': error_message}, request=self._api_request_payload_for_hook(api_kwargs))
        except Exception:
            pass

    def _dump_api_request_debug(self, api_kwargs: Dict[str, Any], *, reason: str, error: Optional[Exception]=None) -> Optional[Path]:
    ...
    def _save_session_log(self, messages: List[Dict[str, Any]]=None):
        ...
        whose external tooling consumes ``~/.duck-agent/sessions/session_{sid}.json``
            ...
            if log_file.exists():
                try:
                    ...
                    if existing_count > len(cleaned):
                        logging.debug('Skipping session log overwrite: existing has %d messages, current has %d', existing_count, len(cleaned))
                        return
                except Exception:
                    pass
            entry = {'session_id': self.session_id, 'model': self.model, 'base_url': self.base_url, 'platform': self.platform, 'session_start': self.session_start.isoformat(), 'last_updated': datetime.now().isoformat(), 'system_prompt': redact_sensitive_text(self._cached_system_prompt or ''), 'tools': self.tools or [], 'message_count': len(cleaned), 'messages': cleaned}
        ...
        def _admit_hard_cancel() -> None:
            ...
            if callable(cancel_before_commit):
                try:
                    ...
                    logger.debug('Compression hard-cancel fence admission failed', exc_info=True)
            event.set()
    ...
    def redirect(self, text: str) -> bool:
        ...
        During a normal Duck Agent model request this cancels only that request;
        ...
        if _redirect_lock is None:
            ...
            if self._interrupt_requested and (not existing):
                return False
            self._pending_redirect = f'{existing}\n\n[Additional user correction]\n{cleaned}' if existing else cleaned
            self._interrupt_requested = True
            self._interrupt_message = None
        else:
            with _redirect_lock:
                ...
                if self._pending_redirect:
                    self._pending_redirect = f'{self._pending_redirect}\n\n[Additional user correction]\n{cleaned}'
                else:
    ...
    def _record_file_mutation_result(self, tool_name: str, args: Dict[str, Any], result: Any, is_error: bool) -> None:
    ...
    def _file_mutation_verifier_enabled(self) -> bool:
        ...
        try:
            ...
            pass
        return True
    _FOOTER_PATH_RE = re.compile('(?<![/:\\w.`])(?:~/|/|[A-Za-z]:[/\\\\])(?:[\\w.\\-]+[/\\\\])*[\\w.\\-]+\\.[\\w]+')
    ...
    def _format_file_mutation_failure_footer(cls, failed: Dict[str, Dict[str, Any]]) -> str:
        ...
        (e.g. ``~/.duck-agent/config.yaml``) to a messaging channel (#35584).
        """
        if not failed:
            return ''
        lines = [f'⚠️ File-mutation verifier: {len(failed)} file(s) were NOT modified this turn despite any wording above that may suggest otherwise. Run `git status` or `read_file` to confirm.']
        shown = 0
    ...
    def _format_turn_completion_explanation(turn_exit_reason: str) -> str:
        ...
        if reason == 'empty_response_exhausted':
            return prefix + 'the model returned empty content after retries and any fallback providers. Try `continue`, switch model/provider, or inspect the tool output above.'
        if reason == 'all_retries_exhausted_no_response':
            return prefix + 'all API retries were exhausted before a response was produced (provider errors / rate limits). Try `continue` or switch provider.'
        if reason == 'partial_stream_recovery':
            return prefix + 'streaming stopped early and only a partial response was recovered. Send `continue` to resume from where it stopped.'
        if reason == 'fallback_prior_turn_content':
            return prefix + 'no new content was produced this turn; showing recovered prior context. Send `continue` to retry.'
        if reason == 'interrupted_during_api_call':
            return prefix + 'the request was interrupted mid-call before a reply was received. Send `continue` to retry.'
        if reason == 'budget_exhausted':
            return prefix + 'the per-turn iteration/cost budget was exhausted before a final answer. Send `continue` to keep going.'
        if reason == 'ollama_runtime_context_too_small':
            return prefix + "the local model's context window was too small to finish. Increase the context size or use a larger model."
        if reason.startswith('max_iterations_reached'):
            return prefix + 'the maximum tool-iteration limit was reached before a final answer. Send `continue` to keep going, or raise `max_iterations`.'
        if reason.startswith('error_near_max_iterations'):
            return prefix + 'an error occurred near the iteration limit before a final answer. Check the tool output above, then send `continue`.'
        if reason == 'pending_tool_result':
            return prefix + 'the turn stopped while a tool result was still pending and the model produced no follow-up text. Send `continue` to let it summarize.'
        if reason == 'session_persistence_failed':
            return prefix + 'the turn was stopped because session storage could not be written (the transcript would have been lost on restart). This is often a full disk — free some space (or fix state.db permissions), then send your message again.'
        return ''
    ...
    def _touch_activity(self, desc: str, *, provenance: Optional[ActivityProvenance]=None, force_persist: bool=False) -> None:
        ...
        """
        from agent.session_activity import bound_activity_description, normalize_activity_provenance, reset_session_activity_persist_window
        ...
        if os.environ.get('HERMES_KANBAN_TASK'):
            try:
                from tools.kanban_tools import heartbeat_current_worker_from_env, inject_new_comments_from_env
    ...
    def _persist_session_activity_if_due(self) -> None:
        ...
        if not callable(touch):
            return
        from agent.session_activity import SESSION_ACTIVITY_HEARTBEAT_MIN_INTERVAL_SECONDS, normalize_activity_provenance
        ...
        try:
            touch(session_id, getattr(self, '_last_activity_ts', None), description=getattr(self, '_last_activity_desc', None), provenance=normalize_activity_provenance(getattr(self, '_last_activity_provenance', None)))
        except Exception:
    ...
    def _capture_credits(self, http_response: Any) -> None:
        ...
        if _fixture is not None:
            ...
            logger.info('credits ▸ [FIXTURE] remaining=%d (%s) · paid=%s · denom=%s · used=%s (real headers bypassed — `echo clear` / unset HERMES_DEV_CREDITS_FIXTURE to restore)', _fixture.remaining_micros, _fixture.remaining_usd or '?', _fixture.paid_access, _fixture.denominator_kind, '%.0f%%' % (_used * 100) if _used is not None else 'n/a')
        ...
        if state is None:
            if _dev:
                logger.info('credits ▸ response had no valid x-nous-credits-* headers (miss — producer off / non-Nous path / >TTL stale)')
            return
        ...
        if _dev:
            ...
            logger.info('credits ▸ remaining=%d (%s) · paid=%s · denom=%s · used=%s · Δspent=%s · age=%s%s', state.remaining_micros, state.remaining_usd or '?', state.paid_access, state.denominator_kind, '%.0f%%' % (used * 100) if used is not None else 'n/a', '%.1f¢' % (spent / 10000) if spent is not None else 'n/a', '%.0fs' % state.age_seconds if state.age_seconds != float('inf') else 'n/a', ' · disabled=%s' % state.disabled_reason if state.disabled_reason else '')
        self._emit_credits_notices()
    ...
    def _sync_external_memory_for_turn(self, *, original_user_message: Any, final_response: Any, interrupted: bool, messages: list | None=None) -> None:
    ...
    def _hydrate_todo_store(self, history: List[Dict[str, Any]]) -> None:
        ...
        for idx in range(len(history) - 1, -1, -1):
            ...
            if len(content) > MAX_TODO_RESULT_CHARS:
                logger.warning('Skipping oversized todo tool response during hydration: session=%s chars=%d', self.session_id or 'none', len(content))
                continue
    ...
    @staticmethod
    def _drop_thinking_only_and_merge_users(messages: List[Dict[str, Any]], *, drop_codex_reasoning_items: bool=True) -> List[Dict[str, Any]]:
        """Forwarder — see ``agent.agent_runtime_helpers.drop_thinking_only_and_merge_users``."""
        from agent.agent_runtime_helpers import drop_thinking_only_and_merge_users
        return drop_thinking_only_and_merge_users(messages, drop_codex_reasoning_items=drop_codex_reasoning_items)
    ...
    def _cap_delegate_task_calls(tool_calls: list) -> list:
        ...
        for tc in tool_calls:
            if tc.function.name == 'delegate_task':
                ...
                truncated.append(tc)
        logger.warning('Truncated %d excess delegate_task call(s) to enforce max_concurrent_children=%d limit', delegate_count - max_children, max_children)
        return truncated
    ...
    def _derive_responses_function_call_id(self, call_id: str, response_item_id: Optional[str]=None) -> str:
    ...
    def _build_keepalive_http_client(base_url: str='', *, verify: Any=True) -> Any:
        ...
        try:
            ...
            _limits = _httpx.Limits(max_keepalive_connections=20, max_connections=100, keepalive_expiry=20.0)
            _timeout = _httpx.Timeout(connect=15.0, read=None, write=15.0, pool=10.0)
            _mounts = {}
            if _proxy is None:
                _mounts = {'http://': _httpx.HTTPTransport(verify=verify), 'https://': _httpx.HTTPTransport(verify=verify)}
            return _httpx.Client(limits=_limits, timeout=_timeout, proxy=_proxy, mounts=_mounts or None, verify=verify)
        except Exception:
            return None
    ...
    def _retire_shared_openai_client(self, client: Any, *, reason: str) -> None:
        ...
        try:
            ...
            logger.info('Shared OpenAI client retired (%s, tcp_shutdown=%d, fd_release=deferred_to_gc) %s', reason, shutdown_count, self._client_log_context())
        except Exception as exc:
    ...
    def _ensure_primary_openai_client(self, *, reason: str) -> Any:
        with self._openai_client_lock():
            ...
            try:
                ...
                logger.warning('Failed to recreate closed OpenAI client (%s) %s error=%s', reason, self._client_log_context(), exc)
                raise RuntimeError('Failed to recreate closed OpenAI client') from exc
            self.client = new_client
        logger.warning('Detected closed shared OpenAI client; recreated before use (%s) %s', reason, self._client_log_context())
    ...
    def _create_request_openai_client(self, *, reason: str, api_kwargs: Optional[dict]=None) -> Any:
        ...
        if base_url_host_matches(str(request_kwargs.get('base_url', '')), 'githubcopilot.com') and self._api_kwargs_have_image_parts(api_kwargs or {}):
        ...
        with self._openai_client_lock():
            ...
            if cached is not None and (not cache['in_use']):
                if not cache['poisoned'] and cache['kwargs'] == request_kwargs and (not self._is_openai_client_closed(cached)):
                    cache['in_use'] = True
                    return cached
                stale = cached
                cache['client'] = None
        ...
        with self._openai_client_lock():
            ...
            if cache['client'] is None:
                cache['client'] = client
                cache['kwargs'] = {k: dict(v) if isinstance(v, dict) else v for k, v in request_kwargs.items()}
                cache['poisoned'] = False
                cache['in_use'] = True
        return client
    ...
    def _abort_request_openai_client(self, client: Any, *, reason: str) -> None:
        ...
        try:
            ...
            _log('OpenAI client aborted (%s, shared=False, tcp_force_closed=%d, deferred_close=stranger_thread) %s%s', reason, shutdown_count, self._client_log_context(), ' — no sockets found; in-flight request may keep running until the provider finishes' if shutdown_count == 0 else '')
        except Exception as exc:
            logger.debug('OpenAI client abort failed (%s, shared=False) %s error=%s', reason, self._client_log_context(), exc)
    ...
    def _create_request_anthropic_client(self, *, reason: str) -> Any:
        ...
        if getattr(self, 'provider', None) == 'bedrock':
            ...
            client = build_anthropic_client(self._anthropic_api_key, getattr(self, '_anthropic_base_url', None), timeout=get_provider_request_timeout(self.provider, self.model), drop_context_1m_beta=_drop_1m)
        logger.debug('Anthropic request client created (%s, shared=False) provider=%s model=%s', reason, getattr(self, 'provider', None), getattr(self, 'model', None))
        return client
    ...
    def _close_request_anthropic_client(self, client: Any, *, reason: str) -> None:
        ...
        try:
            ...
            client.close()
            logger.info('Anthropic client closed (%s, shared=False) provider=%s model=%s', reason, getattr(self, 'provider', None), getattr(self, 'model', None))
        except Exception as exc:
            logger.debug('Anthropic client close failed (%s, shared=False) provider=%s model=%s error=%s', reason, getattr(self, 'provider', None), getattr(self, 'model', None), exc)
    ...
    def _abort_request_anthropic_client(self, client: Any, *, reason: str) -> None:
        ...
        try:
            shutdown_count = self._force_close_tcp_sockets(client)
            _log = logger.warning if shutdown_count == 0 else logger.info
            _log('Anthropic client aborted (%s, shared=False, tcp_force_closed=%d, deferred_close=stranger_thread) provider=%s model=%s%s', reason, shutdown_count, getattr(self, 'provider', None), getattr(self, 'model', None), ' — no sockets found; in-flight request may keep running until the provider finishes' if shutdown_count == 0 else '')
        except Exception as exc:
            logger.debug('Anthropic client abort failed (%s, shared=False) provider=%s model=%s error=%s', reason, getattr(self, 'provider', None), getattr(self, 'model', None), exc)
    ...
    def _try_refresh_codex_client_credentials(self, *, force: bool=True) -> bool:
        ...
        if singleton_key and active_key and (singleton_key != active_key):
            logger.debug('%s singleton tokens differ from the active api_key; skipping singleton force-refresh to avoid silent account swap. Reactive credential rotation should go through the pool.', self.provider)
            return False
        try:
            if self.provider == 'openai-codex':
                from hermes_cli.auth import resolve_codex_runtime_credentials
    ...
    def _try_refresh_nous_client_credentials(self, *, force: bool=True) -> bool:
        ...
        try:
            ...
            creds = resolve_nous_runtime_credentials(timeout_seconds=env_float('HERMES_NOUS_TIMEOUT_SECONDS', 15), force_refresh=force)
        except Exception as exc:
    ...
    def _try_refresh_env_client_credentials(self) -> bool:
        """Adopt ~/.duck-agent/.env credential/base-url edits at the turn boundary.

        A Settings save (desktop ``PUT /api/env``, ``duck-agent setup``) updates
        ...
        if pconfig and getattr(pconfig, 'auth_type', '') == 'api_key' and getattr(pconfig, 'api_key_env_vars', ()):
            ...
            if self.provider == 'kimi-coding':
                ...
                base_url = _resolve_kimi_base_url(api_key, pconfig.inference_base_url, env_url).rstrip('/')
            elif self.provider == 'zai':
                from hermes_cli.auth import _resolve_zai_base_url
                base_url = _resolve_zai_base_url(api_key, pconfig.inference_base_url, env_url).rstrip('/')
        ...
        if prev is None:
            adopt = current_base == default_base and (not (base_url == current_base and api_key == self.api_key))
        else:
            adopt = resolved != prev and current_base in {default_base, prev[0]} and (not (base_url == current_base and api_key == self.api_key))
        if not adopt:
    ...
    def _try_recover_stale_copilot_credential(self) -> bool:
        ...
        if api_token == raw_token and (not enterprise_base_url):
            logger.warning('Copilot stale-credential recovery: exchange still degraded to raw token; skipping retry (network/exchange endpoint unavailable).')
            return False
    ...
    def _try_refresh_anthropic_client_credentials(self) -> bool:
        ...
        try:
            ...
            pass
        try:
            self._anthropic_client = build_anthropic_client(new_token, getattr(self, '_anthropic_base_url', None), timeout=get_provider_request_timeout(self.provider, self.model))
        except Exception as exc:
    ...
    def _apply_client_headers_for_base_url(self, base_url: str, *, apply_user_headers: bool=True) -> None:
        from agent.auxiliary_client import _AI_GATEWAY_HEADERS, build_nvidia_nim_headers, build_or_headers
    ...
    def _swap_credential(self, entry) -> None:
        ...
        if self.api_mode == 'anthropic_messages':
            ...
            self._anthropic_client = build_anthropic_client(runtime_key, self._anthropic_base_url, timeout=get_provider_request_timeout(self.provider, self.model))
    ...
    def _reapply_route_client_config(self, *, route_changed: bool) -> None:
        ...
        try:
            from hermes_cli.config import apply_custom_provider_tls_to_client_kwargs, get_compatible_custom_providers, load_config_readonly
            apply_custom_provider_tls_to_client_kwargs(self._client_kwargs, str(self.base_url or ''), get_compatible_custom_providers(load_config_readonly()))
        except Exception:
    ...
    def _recover_with_credential_pool(self, *, status_code: Optional[int], has_retried_429: bool, classified_reason: Optional[FailoverReason]=None, error_context: Optional[Dict[str, Any]]=None) -> tuple[bool, bool]:
    ...
    def _anthropic_messages_create(self, api_kwargs: dict, *, client: Any=None):
        ...
        return create_anthropic_message(client or self._anthropic_client, api_kwargs, log_prefix=getattr(self, 'log_prefix', ''), prefer_stream=not bool(getattr(self, '_disable_streaming', False)), on_response=self._capture_anthropic_response_headers)
    ...
    def _rebuild_anthropic_client(self) -> None:
        ...
        if getattr(self, 'provider', None) == 'bedrock':
            ...
            from agent.anthropic_adapter import build_anthropic_client
            self._anthropic_client = build_anthropic_client(self._anthropic_api_key, getattr(self, '_anthropic_base_url', None), timeout=get_provider_request_timeout(self.provider, self.model), drop_context_1m_beta=_drop_1m)
    ...
    def _interim_content_was_streamed(self, content: str) -> bool:
        ...
        if not visible_content:
            return False
        streamed = self._normalize_interim_visible_text(self._strip_think_blocks(getattr(self, '_current_streamed_assistant_text', '') or ''))
    ...
    def _note_dropped_stream_writer(self, where: str) -> None:
        ...
        if _n == 1 or _n & _n - 1 == 0:
            logger.warning('Dropped delta from a superseded stream writer at %s (discarded=%d this turn) — a stale stream tried to write into the turn after a retry superseded it.', where, _n)
    ...
    def _materialize_data_url_for_vision(image_url: str) -> tuple[str, Optional[Path]]:
        ...
        if header.startswith('data:'):
            ...
            if mime_part.startswith('image/'):
                mime = mime_part
        suffix = {'image/png': '.png', 'image/gif': '.gif', 'image/webp': '.webp', 'image/jpeg': '.jpg', 'image/jpg': '.jpg'}.get(mime, '.jpg')
    ...
    def _describe_image_for_anthropic_fallback(self, image_url: str, role: str) -> str:
        ...
        analysis_prompt = 'Describe everything visible in this image in thorough detail. Include any text, code, UI, data, objects, people, layout, colors, and any other notable visual information.'
    ...
    def _prepare_anthropic_messages_for_api(self, api_messages: list) -> list:
        ...
        for msg in transformed:
            if not isinstance(msg, dict):
                continue
            msg['content'] = self._preprocess_anthropic_content(msg.get('content'), str(msg.get('role', 'user') or 'user'))
        return transformed
    ...
    def _tool_result_content_for_active_model(self, tool_name: str, result: Any) -> Any:
        ...
        if self._model_supports_vision():
            if not self._provider_supports_vision_tool_messages():
                logger.debug('Tool %s: provider %s does not accept list-type tool content — sending text summary', tool_name, getattr(self, 'provider', ''))
                return _multimodal_text_summary(result)
            key = ((getattr(self, 'provider', '') or '').strip().lower(), (getattr(self, 'model', '') or '').strip())
            no_list = getattr(self, '_no_list_tool_content_models', None)
            if no_list and key in no_list:
                logger.debug('Tool %s: model %s/%s known to reject list-type tool content this session — sending text summary', tool_name, key[0], key[1])
                return _multimodal_text_summary(result)
            return content
        summary = _multimodal_text_summary(result)
        if tool_name == 'computer_use':
            return json.dumps({'error': 'computer_use returned screenshot/image content, but the active model/provider does not support image input. Switch to a vision-capable model for desktop computer use, or use browser tools for browser tasks.', 'text_summary': summary})
        logger.warning('Tool %s returned image content for non-vision model %s/%s; falling back to text summary', tool_name, self.provider, self.model)
        return summary

    def _try_shrink_image_parts_in_messages(self, api_messages: list, *, max_dimension: int=8000) -> bool:
        ...
        return try_shrink_image_parts_in_messages(api_messages, max_dimension=max_dimension)

    def _try_strip_image_parts_from_tool_messages(self, api_messages: list, *, remember_model: bool=True) -> bool:
        ...
        for msg in api_messages:
            ...
            if text_parts:
                ...
                msg['content'] = '[image content removed — provider does not accept list-type tool message content]'
            changed = True
        return changed
    ...
    def _anthropic_preserve_dots(self) -> bool:
        ...
        if (getattr(self, 'provider', '') or '').lower() in {'alibaba', 'minimax', 'minimax-cn', 'opencode-go', 'opencode-zen', 'zai', 'bedrock', 'xiaomi', 'vertex'}:
            return True
        base = (getattr(self, 'base_url', '') or '').lower()
        return 'dashscope' in base or 'aliyuncs' in base or 'minimax' in base or ('opencode.ai/zen/' in base) or ('bigmodel.cn' in base) or ('xiaomimimo.com' in base) or ('aiplatform.googleapis.com' in base) or ('bedrock-runtime.' in base)
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if base_url_host_matches(self._base_url_lower, 'ai-gateway.vercel.sh'):
            return True
        if base_url_host_matches(self._base_url_lower, 'models.github.ai') or base_url_host_matches(self._base_url_lower, 'githubcopilot.com'):
            try:
        ...
        reasoning_model_prefixes = ('deepseek/', 'anthropic/', 'openai/', 'x-ai/', 'google/gemini-2', 'google/gemma-4', 'qwen/qwen3', 'tencent/hy3', 'xiaomi/')
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        try:
            ...
            opts = lmstudio_model_reasoning_options(self.model, self.base_url, getattr(self, 'api_key', ''))
        except Exception:
            opts = []
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            ...
            supported = ollama_model_supports_thinking(self.model, self.base_url, getattr(self, 'api_key', ''))
        except Exception:
            supported = None
    ...
    def _needs_thinking_reasoning_pad(self) -> bool:
        ...
        if cached is not None and cached[0] == key:
            return cached[1]
        result = self._needs_deepseek_tool_reasoning() or self._needs_kimi_tool_reasoning() or self._needs_mimo_tool_reasoning()
    ...
    def _sanitize_tool_calls_for_strict_api(api_msg: dict, model: 'str | None'=None) -> dict:
        ...
        api_msg['tool_calls'] = [{k: v for k, v in tc.items() if k not in _STRIP_KEYS} if isinstance(tc, dict) else tc for tc in tool_calls]
        return api_msg

    @staticmethod
    def _sanitize_tool_call_arguments(messages: list, *, logger=None, session_id: str=None, cursor=None) -> int:
        ...
        return sanitize_tool_call_arguments(messages, logger=logger, session_id=session_id, cursor=cursor)
    ...
    def _compress_context(self, messages: list, system_message: str, *, approx_tokens: int=None, task_id: str='default', focus_topic: str=None, force: bool=False, defer_context_engine_notification: bool=False, commit_fence=None) -> tuple:
        ...
        ``force=False``.
        """
        from agent.conversation_compression import CompressionCommitFence, compress_context, resolve_context_compression_timeouts, run_compress_context_with_progress_timeout
        from agent.portal_tags import get_conversation_context, reset_conversation_context, set_conversation_context
        token = None
        ...
        try:
            ...
            def _run(fence=None, target_messages=None):
                return compress_context(self, target_messages if target_messages is not None else messages, system_message, approx_tokens=approx_tokens, task_id=task_id, focus_topic=focus_topic, force=force, defer_context_engine_notification=defer_context_engine_notification, commit_fence=fence)
            ...
            def _on_timeout(idle, waited, since_progress):
                logger.warning('Context compression made no progress for %.1fs (total wait %.1fs, ceiling %.1fs); continuing without compression', since_progress, waited, total_ceiling)
                ...
                if callable(emit):
                    emit(f'⚠ Context compression timed out after {idle:.1f}s with no output from the summary model. No messages were dropped — continuing without compression. Run /compress to retry, /new for a clean session, or check auxiliary.compression.')

            def _on_commit_overrun(waited, ceiling):
                emit = getattr(self, '_emit_warning', None)
                if callable(emit):
                    emit(f'⚠ Context compression commit is taking unusually long ({waited:.0f}s, ceiling {ceiling:.0f}s). Waiting for it to finish safely — if this persists, check SessionDB health (disk / lock contention).')
            result = run_compress_context_with_progress_timeout(worker=_snapshot_worker, messages=messages, system_prompt_fallback=_fallback_prompt, idle_timeout_seconds=idle_timeout, total_ceiling_seconds=total_ceiling, on_timeout=_on_timeout, on_commit_overrun=_on_commit_overrun, fence=active_fence, telemetry_agent=self)
            try:
    ...
    def _toolguard_controlled_halt_response(self, decision: ToolGuardrailDecision) -> str:
        ...
        return f'I stopped retrying {tool} because it hit the tool-call guardrail ({decision.code}) after {decision.count} repeated non-progressing attempts. The last tool result explains the blocker; the next step is to change strategy instead of repeating the same call.'

    def _append_guardrail_observation(self, tool_name: str, function_args: dict, function_result: str, *, failed: bool) -> str:
    ...
    def _execute_tool_calls(self, assistant_message, messages: list, effective_task_id: str, api_call_count: int=0) -> None:
        ...
        try:
            ...
            return execute_tool_calls_segmented(self, assistant_message, messages, effective_task_id, api_call_count, segments=segments)
        finally:
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        return _delegate_task(goal=function_args.get('goal'), context=function_args.get('context'), tasks=_strip_model_hidden_task_fields(function_args.get('tasks')), max_iterations=function_args.get('max_iterations'), role=function_args.get('role'), background=not _is_subagent, parent_agent=self)

    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str, tool_call_id: Optional[str]=None, messages: list=None, pre_tool_block_checked: bool=False, skip_tool_request_middleware: bool=False, tool_request_middleware_trace: Optional[list[dict[str, Any]]]=None, skip_tool_execution_middleware: bool=False) -> str:
        """Forwarder — see ``agent.agent_runtime_helpers.invoke_tool``."""
        from agent.agent_runtime_helpers import invoke_tool
        return invoke_tool(self, function_name, function_args, effective_task_id, tool_call_id, messages, pre_tool_block_checked, skip_tool_request_middleware, tool_request_middleware_trace, skip_tool_execution_middleware)
    ...
    def run_conversation(self, user_message: Any, system_message: str=None, conversation_history: List[Dict[str, Any]]=None, task_id: str=None, stream_callback: Optional[callable]=None, persist_user_message: Optional[Any]=None, persist_user_timestamp: Optional[float]=None, persist_user_display_kind: Optional[str]=None, persist_user_display_metadata: Optional[Dict[str, Any]]=None, moa_config: Optional[dict[str, Any]]=None) -> Dict[str, Any]:
        ...
        task_context = {'session_id': session_id, 'task_id': effective_task_id, 'platform': getattr(self, 'platform', None) or ''}
        relay_turn_id = f"{session_id or 'session'}:{effective_task_id}:{uuid.uuid4().hex[:8]}"
        self._relay_pending_turn_id = relay_turn_id
        relay_parent_session_id = str(getattr(self, '_parent_session_id', None) or '') if task_context['platform'] == 'subagent' else ''
        relay_lease = None
        relay_turn = None
        token = None
        acct_token = None
        ...
        try:
            relay_lease = relay_runtime.SESSION_COORDINATOR.acquire_conversation(profile_key=relay_runtime.current_profile_key(), session_id=task_context['session_id'], platform=task_context['platform'], parent_session_id=relay_parent_session_id, model=str(getattr(self, 'model', None) or ''))
            relay_turn = relay_runtime.SESSION_COORDINATOR.begin_turn(relay_lease, turn_id=relay_turn_id, task_id=effective_task_id)
            if getattr(relay_turn, 'relay_enabled', True):
                start_task_run(**task_context, parent_session_id=getattr(self, '_parent_session_id', None) or '')
                task_started = True
            ...
            with bind_subagent_parent(self), scoped_runtime_main({}):
                result = run_conversation(self, user_message, system_message, conversation_history, effective_task_id, stream_callback, persist_user_message, persist_user_timestamp=persist_user_timestamp, persist_user_display_kind=persist_user_display_kind, persist_user_display_metadata=persist_user_display_metadata, moa_config=moa_config)
            ...
            if isinstance(exc, (KeyboardInterrupt, InterruptedError)) or type(exc).__name__ == 'CancelledError':
                relay_outcome = 'cancelled'
    ...
    def _run_codex_app_server_turn(self, *, user_message: str, original_user_message: Any, messages: List[Dict[str, Any]], effective_task_id: str, should_review_memory: bool=False) -> Dict[str, Any]:
...
def main(query: str=None, model: str='', api_key: str=None, base_url: str='', max_turns: int=10, enabled_toolsets: str=None, disabled_toolsets: str=None, list_tools: bool=False, save_trajectories: bool=False, save_sample: bool=False, verbose: bool=False, log_prefix_chars: int=20):
    ...
    try:
        agent = AIAgent(base_url=base_url, model=model, api_key=api_key, max_iterations=max_turns, enabled_toolsets=enabled_toolsets_list, disabled_toolsets=disabled_toolsets_list, save_trajectories=save_trajectories, verbose_logging=verbose, log_prefix_chars=log_prefix_chars)
    except RuntimeError as e:
        print(f'❌ Failed to initialize agent: {e}')
        return
    if query is None:
        user_query = 'Tell me about the latest developments in Python 3.13 and what new features developers should know about. Please search for current information and try it out.'
    else:
        user_query = query
    ...
    if save_sample:
        ...
        entry = {'conversations': trajectory, 'timestamp': datetime.now().isoformat(), 'model': model, 'completed': result['completed'], 'query': user_query}
        try:
