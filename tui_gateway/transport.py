...
_PEER_GONE_ERRNOS = frozenset({errno.EPIPE, errno.ECONNRESET, errno.EBADF, errno.ESHUTDOWN, getattr(errno, 'WSAECONNRESET', -1), getattr(errno, 'WSAESHUTDOWN', -1)} - {-1})
...
_current_transport: contextvars.ContextVar[Optional[Transport]] = contextvars.ContextVar('hermes_gateway_transport', default=None)
