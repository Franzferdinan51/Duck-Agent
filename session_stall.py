...
def should_emit_session_stall_notification(*, timeout_seconds: float, idle_seconds: Optional[float], has_pending_inbound: bool, already_notified: bool) -> bool:
...
def should_clear_session_stall_notification(*, timeout_seconds: float, idle_seconds: Optional[float], has_pending_inbound: bool) -> bool:
...
def resolve_session_idle_seconds_from_activity(activity: Optional[Mapping[str, Any]], *, now: Optional[float]=None) -> Optional[float]:
