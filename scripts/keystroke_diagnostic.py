...
Useful when adding a keybinding to Duck Agent (or any prompt_toolkit app) and you
...
Then in Duck Agent, bind the newline behaviour to that key:
    @kb.add('c-j')
...
def _header() -> list[str]:
    return ['Keystroke diagnostic — press keys to see how prompt_toolkit sees them.', 'Try: Enter, Ctrl+Enter, Shift+Enter, Alt+Enter, Ctrl+J, Ctrl+M, arrows, Home/End.', 'Ctrl+Q or Ctrl+C to quit. Last 20 keystrokes shown.', '']
