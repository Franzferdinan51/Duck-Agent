#!/bin/bash
# ============================================================================
# Duck Agent Installer
# ============================================================================
# Installation script for Linux, macOS, and Android/Termux.
# Uses uv for desktop/server installs and Python's stdlib venv + pip on Termux.
#
# Usage:
#   curl -fsSL https://duck-agent.franzferdinan.com/install.sh | bash
#
# Or with options:
...
# Python-driven tool session (e.g. Duck Agent terminal tool). A pre-set PYTHONPATH
...
# Configuration
REPO_URL_SSH="git@github.com:Franzferdinan51/Duck-Agent.git"
REPO_URL_HTTPS="https://github.com/Franzferdinan51/Duck-Agent.git"
DUCK_AGENT_HOME="${DUCK_AGENT_HOME:-${HERMES_HOME:-$HOME/.duck-agent}}"
