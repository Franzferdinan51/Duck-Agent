...
1. Bundled plugins: ``plugins/model-providers/<name>/`` (shipped with duck-agent)
2. User plugins: ``$DUCK_AGENT_HOME/plugins/model-providers/<name>/``
...
def register_provider(profile: ProviderProfile) -> None:
    ...
    plugins under ``$DUCK_AGENT_HOME/plugins/model-providers/`` can override
...
def _user_plugins_dir() -> Path | None:
    """Return ``$DUCK_AGENT_HOME/plugins/model-providers/`` if it exists."""
    try:
...
def _discover_providers() -> None:
    ...
    Order:
      ...
      2. User plugins at ``$DUCK_AGENT_HOME/plugins/model-providers/<name>/``
