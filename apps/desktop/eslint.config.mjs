...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @duck-agent/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@duck-agent/shared'],
              message: 'Plugins import only @duck-agent/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
