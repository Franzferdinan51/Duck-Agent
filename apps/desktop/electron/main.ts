...
function resolveHermesHome() {
  ...
  if (IS_WINDOWS && process.env.LOCALAPPDATA) {
    const localappdata = path.join(process.env.LOCALAPPDATA, 'duck-agent')
...
const ACTIVE_HERMES_ROOT = path.join(HERMES_HOME, 'duck-agent-agent')
