...
test('resolveRemovableAppPath finds the install dir on Windows', () => {
  ...
  assert.equal(
    resolveRemovableAppPath('C:\\Users\\x\\AppData\\Local\\duck-agent-desktop\\Hermes.exe', 'win32'),
    'C:\\Users\\x\\AppData\\Local\\duck-agent-desktop'
  )
})
...
test('buildPosixCleanupScript waits for the PID, runs the uninstall module, removes bundle', () => {
  const script = buildPosixCleanupScript({
    desktopPid: 4321,
    pythonExe: '/home/x/.hermes/duck-agent-agent/venv/bin/python',
    pythonPath: null,
    agentRoot: '/home/x/.hermes/duck-agent-agent',
...
test('buildPosixCleanupScript exports PYTHONPATH when pythonPath is set (lite/full)', () => {
  const script = buildPosixCleanupScript({
    ...
    pythonPath: '/home/x/.hermes/duck-agent-agent',
    agentRoot: '/home/x/.hermes/duck-agent-agent',
  ...
  // venv is torn down.
  assert.match(script, /export PYTHONPATH='\/home\/x\/\.hermes\/duck-agent-agent'/)
