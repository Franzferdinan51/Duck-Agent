...
const SKIN_KEY = 'duck-agent-desktop-theme-v2'
const MODE_KEY = 'duck-agent-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'duck-agent-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'duck-agent-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'duck-agent-desktop-active-profile-v1'
...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  try {
    window.localStorage.setItem('duck-agent-boot-background', chromeBg)
    window.localStorage.setItem('duck-agent-boot-color-scheme', rendered)
  } catch {
