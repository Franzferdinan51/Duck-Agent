...
export const zh: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        'Duck Agent Desktop 默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 Hermes 后端时，可以使用远程网关。下面可按 profile 指定各自的远程主机。',
      appliesTo: '应用于',
      ...
      sshErrNotInstalled:
        '远程主机上未安装 Hermes。请在远程安装（curl -fsSL https://duck-agent-agent.nousresearch.com/install.sh | sh）或设置 Hermes 路径。',
