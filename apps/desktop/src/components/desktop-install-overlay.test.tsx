...
describe('DesktopInstallOverlay first-run setup', () => {
  ...
  it('surfaces a recoverable error when the local-bootstrap bridge is unavailable', async () => {
    ...
    expect(
      await screen.findByText('Local installation could not start. Restart Duck Agent Desktop and try again.')
    ).toBeTruthy()
  ...
  it('keeps the local-start error when the first snapshot commits under the click', async () => {
    ...
    expect(screen.queryByText('Local installation could not start. Restart Duck Agent Desktop and try again.')).toBeTruthy()
  })
  ...
  it('clears a stale local-start error when a repair presents a different root', async () => {
    ...
    expect(screen.queryByText('Local installation could not start. Restart Duck Agent Desktop and try again.')).toBeNull()
  })
