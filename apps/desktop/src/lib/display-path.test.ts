...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/duck-agent-agent')).toBe('~/www/duck-agent-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/duck-agent-agent')).toBe('duck-agent-agent')
    expect(pathLeaf('~/www/duck-agent-agent')).toBe('duck-agent-agent')
