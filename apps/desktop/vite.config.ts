...
const dependencyPath = (name: string) =>
  real(path.resolve(__dirname, 'node_modules', name)) ?? path.resolve(__dirname, '../../node_modules', name)
...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\hermes\duck-agent-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@duck-agent/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@duck-agent/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@duck-agent/shared': path.resolve(__dirname, '../shared/src'),
      react: dependencyPath('react'),
      'react-dom': dependencyPath('react-dom'),
      'react/jsx-dev-runtime': path.join(dependencyPath('react'), 'jsx-dev-runtime.js'),
      'react/jsx-runtime': path.join(dependencyPath('react'), 'jsx-runtime.js')
    },
