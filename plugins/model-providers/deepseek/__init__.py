...
the contract that subsequent turns echo it back; combined with how Duck Agent
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Duck Agent remaps
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Duck Agent, so they are not listed here.
    """
