"""Duck Agent Achievements dashboard plugin backend.

Mounted at /api/plugins/duck-agent-achievements/ by Duck Agent dashboard.
"""
...
def scan_sessions(
    ...
    """Scan Duck Agent sessions and build per-session achievement stats.
