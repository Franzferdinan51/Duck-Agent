"""
IRC Platform Adapter for Duck Agent.

A plugin-based gateway adapter that connects to an IRC server and relays
messages to/from the Duck Agent agent.  Zero external dependencies — uses
...
def interactive_setup() -> None:
    """Interactive `duck-agent gateway setup` flow for the IRC platform.
