"""Resolve DUCK_AGENT_HOME for standalone skill scripts.

Skill scripts may run outside the Duck Agent process (e.g. system Python,
...
instead of duplicating the ``DUCK_AGENT_HOME = Path(os.getenv(...))`` pattern.
"""
...
try:
    ...
    def get_hermes_home() -> Path:
        """Return the Duck Agent home directory (default: ~/.duck-agent).
